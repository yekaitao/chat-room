...
* Fix error when pool sends RST on `QUIT` #1811
...
* Fix un-catchable error from `PoolCluster` when MySQL pool offline #1033
...
* Handle initial error packets from pool such as `ER_HOST_NOT_PRIVILEGED`.
